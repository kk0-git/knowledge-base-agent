...
from agent.tools.profile.common import CATEGORIES, SCOPES, append_session_observation_draft, context_note_paths, current_topic, normalize_enum
...
def write_observation_draft(args: dict[str, Any], ctx: Any) -> dict[str, Any]:
    ...
    draft = {
        ...
        "category": normalize_enum(args.get("category"), CATEGORIES, "knowledge_gap"),
